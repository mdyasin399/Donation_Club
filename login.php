<html>
  ...
  <header></header>
    ...
    <!--Photo show on screen -->

  <div  class="min-h-screen bg-gray-100 text-gray-900 flex justify-center">
    <div class="max-w-screen-xl m-0 sm:m-20 bg-white shadow sm:rounded-lg flex justify-center flex-1">
      <div class="flex-1 bg-indigo-100 text-center hidden lg:flex">
        <div class="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat" style="background-image: url('img/admin.png'); "></div>
      ...
      <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
        ...
        <div class="w-full flex-1 mt-8">
            ...
            <div class="my-12 border-b text-center">
              <div class="leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2">Enter email & Password</div>
            </div>
            ...
            <div class="mx-auto max-w-xs">
              ...
              <p class="mt-6 text-xs text-gray-600 text-center">Dont have an account?
                <a href="signup.php" class="border-b border-gray-500 border-dotted"> Create Now!</a>
              </p>
              <p class="mt-6 text-xs text-gray-600 text-center">Or, login as<a href="admin-login.php" class="border-b border-gray-500 border-dotted"> admin</a>
              </p>
