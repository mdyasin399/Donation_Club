...
<div class="main">
	...
	<div class="content">
	  ...
	  <table class="table">
		  ...
		  <?php 
		  $stu = mysqli_query($db,"SELECT * FROM students")or die(mysqli_error());
		  	...
		  	while($s = mysqli_fetch_assoc($stu))
          {
		   ...
		   ?>
		  	<tr>
		  		...
		  		<td><img src="../uploads/<?php echo $s['img']; ?>" height="50" width="50" alt=""
              loading="lazy"/></td>
		    	<td><?php echo $s['id']; ?></td>
		    	...
		    	<td><form action="admin-process.php" method="POST">
