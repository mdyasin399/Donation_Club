      ...
      <form  method="post" enctype="multipart/form-data" action="editprofile.php">
        <div class="user-details">
          ...
          <div class="input-box">
            ...
            <input type="text" value="<?php echo $row['Rank']; ?>" disabled> <!--for admin use -->
          </div>
          <div class="input-box">
      ...
      if(isset($_POST['submit'])){
        ...
        $result = mysqli_query($db, $query2) or die("Query Unsuccessful.");
            if (move_uploaded_file($tempname, $folder)) {
		        ...
		        if ($result) {
            echo "<div class='form'><h3>Account Info Updated successfully.</h3><br/></div>";
        }
