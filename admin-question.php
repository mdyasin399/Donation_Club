...
<div class="main">
	...
	<div class="content">
	  ...
	  <table class="table table-hover">
       ...
       JOIN subjects sub ON q.subject_code=sub.s_code")or die(mysqli_error());
		  	...
		  	while($s = mysqli_fetch_assoc($stu))
          {
		   ...
		   ?>
		  	<tr class="align-middle">
		    	...
		    	<td><?php if(strlen($s['question_detail'])>150){ echo substr($s['question_detail'], 0, 100);} else { echo $s['question_detail'];}  ?></td>
		    	<td><?php echo $s['Subject_Name']; ?></td>
		    	<td><?php echo $s['ques_points']; ?></td>
		    	<td><?php echo $s['username']; ?></td>
		    	<td><img src="../uploads/<?php echo $s['question_img']; ?>" height="70" width="70" alt=""
              loading="lazy"/></td>
